        ...
        <div class="card-body">
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="year" id="year" min="1900" max="{{ date('Y') }}" class="form-control @error('year') is-invalid @enderror" value="{{ old('year', $book->year) }}">
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="stock" id="stock" min="0" class="form-control @error('stock') is-invalid @enderror" value="{{ old('stock', $book->stock) }}" required>
                    <div class="form-hint">Saat ini sedang dipinjam: {{ $book->activeLoansCount() }} buku.</div>
            ...
            <div class="form-group">
                ...
                <div style="display: flex; gap: 16px; align-items: flex-start;">
                    <div style="width: 120px; height: 160px; background: var(--color-bg); border-radius: var(--radius); border: 2px dashed var(--color-border); display: flex; align-items: center; justify-content: center; overflow: hidden;" id="coverPreviewContainer">
                        @if($book->cover)
                            <img id="coverPreview" src="{{ Storage::url($book->cover) }}" style="width: 100%; height: 100%; object-fit: cover;">
                            <i data-feather="image" style="display:none; color: var(--color-muted);"></i>
                        @else
                    ...
                    <div style="flex: 1;">
                        ...
                        <div class="form-hint">Biarkan kosong jika tidak ingin mengubah cover. Format yang diizinkan: JPG, JPEG, PNG. Maksimal 2MB. Rasio ideal 3:4.</div>
